...
const ReportLastYear = ({ setLocalData, localData, handleFileRemove }) => (
  <Box
    sx={{
      backgroundColor: '#fff',
      ...
      <FormControl fullWidth>
        ...
        >
          ...
          <Switch
            ...
            inputProps={{ 'aria-label': 'controlled' }}
            sx={{ marginLeft: '8px' }}
            checked={localData.Lock_audit_report_lastyear ?? false}
            onChange={(e) =>
              setLocalData({
                ...localData,
      ...
      <FormControl fullWidth>
        ...
        >
          ...
          <Switch
            ...
            inputProps={{ 'aria-label': 'controlled' }}
            sx={{ marginLeft: '8px' }}
            checked={localData.Lock_statement_lastyear ?? false}
            onChange={(e) =>
              setLocalData({
                ...localData,
